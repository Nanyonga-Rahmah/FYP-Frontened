export const Register = `${import.meta.env.VITE_BACKEND_URL}/auth/register`;
export const Login = `${import.meta.env.VITE_BACKEND_URL}/auth/signin`;
export const FarmCreate = `${import.meta.env.VITE_BACKEND_URL}/farm/create`;
export const AllFarms = `${import.meta.env.VITE_BACKEND_URL}/farm/all`;
export const FarmerFarms = `${import.meta.env.VITE_BACKEND_URL}/farm//farmer/farm`;
