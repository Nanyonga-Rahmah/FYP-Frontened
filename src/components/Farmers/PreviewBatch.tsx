...
export function PreviewBatch({ handlePrevious, data }: PreviewBatchProps) {
  ...
  return (
    <>
      <div className="mt-6 space-y-6 text-sm text-gray-700">
        <div className="flex justify-between">
          ...
          <div className="text-right space-y-1">
            <div className="flex justify-end items-center gap-2">
              <span className="text-black font-medium">HRV-001</span>
        ...
        <div className="flex justify-between">
          <div className="text-gray-500">Processing units</div>
          <div className="text-right space-y-1">
            {data.processing_units.map((unit: string, index: number) => (
