// components/modals/ApproveHarvestModal.tsx
...
export default function ApproveHarvestModal({ isOpen, onClose, onApprove }: Props) {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/30 flex items-center justify-center">
      <div className="bg-white rounded-xl p-6 w-full max-w-md shadow-lg relative">
        ...
        <h2 className="text-lg font-semibold text-black mb-2">Approve Harvest ?</h2>
        <p className="text-sm text-gray-600 mb-4">
          Are you sure you want to approve this farmer's harvest This action cannot be undone.
        </p>
        <div className="mb-4">
          <label className="text-sm font-medium text-black mb-1 block">Adjusted Number of Bags*</label>
          <textarea
            value={notes}
