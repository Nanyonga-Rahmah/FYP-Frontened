// components/modals/RejectHarvestModal.tsx
...
export default function RejectHarvestModal({ isOpen, onClose, onReject }: Props) {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/30 flex items-center justify-center">
      <div className="bg-white rounded-xl p-6 w-full max-w-md shadow-lg relative">
        ...
        <h2 className="text-lg font-semibold text-black mb-2">Reject Harvest ?</h2>
        <p className="text-sm text-gray-600 mb-4">
          Are you sure you want to reject this farm's harvest ? Please provide a reason.
        </p>
        <div className="mb-4">
